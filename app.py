...
<!-- قسم إخلاء المسؤولية القانونية والمالية -->
    <div class="box-info mb-3 text-center" style="border-color: rgba(239, 68, 68, 0.3); background-color: rgba(239, 68, 68, 0.05);">
        <div class="text-danger fw-bold small mb-1">⚠️ إخلاء مسؤولية هام:</div>
        <div class="small text-secondary" style="font-size: 0.75rem; line-height: 1.5;">
            المعلومات والتحليلات المعروضة في هذه المنصة هي لأغراض تعليمية وإعلامية فقط، ولا تُعتبر نصيحة مالية، أو استثمارية، أو دعوة لشراء أو بيع أي أصول مالية أو أسهم. التداول في الأسواق المالية والعملات الرقمية ينطوي على مخاطر عالية قد تؤدي إلى خسارة رأس المال. أنت وحدك المسؤول عن قراراتك الاستثمارية والمالية.
        </div>
    </div>
# -------------------------------------------------------------
